...
TEST(WMFCodec, InvalidDataCorruptingGdiPlus)
{
	STARTUP
...
TEST(WMFCodec, InvalidPlaceableHeader)
{
	STARTUP
...
TEST(WMFCodec, InvalidMetafileHeader)
{
	STARTUP
...
TEST(WMFCodec, InvalidImageData)
{
	STARTUP
