...
static GpGraphics *graphics;

TEST(Region, CreateRegion)
{
	STARTUP
...
TEST(Region, CreateRegionRgnData)
{
	STARTUP
	GdipCreateBitmapFromScan0 (10, 10, 0, PixelFormat32bppRGB, NULL, (GpBitmap **) &image);
	GdipGetImageGraphicsContext (image, &graphics);
...
TEST(Region, getRegionDataReplace)
{
	STARTUP
	GdipCreateBitmapFromScan0 (10, 10, 0, PixelFormat32bppRGB, NULL, (GpBitmap **) &image);
	GdipGetImageGraphicsContext (image, &graphics);
...
TEST(Region, getRegionDataUnion)
{
	STARTUP
	GdipCreateBitmapFromScan0 (10, 10, 0, PixelFormat32bppRGB, NULL, (GpBitmap **) &image);
	GdipGetImageGraphicsContext (image, &graphics);
...
TEST(Region, getRegionDataComplement)
{
	STARTUP
	GdipCreateBitmapFromScan0 (10, 10, 0, PixelFormat32bppRGB, NULL, (GpBitmap **) &image);
	GdipGetImageGraphicsContext (image, &graphics);
...
TEST(Region, isVisibleRegionPoint)
{
	STARTUP
	GdipCreateBitmapFromScan0 (10, 10, 0, PixelFormat32bppRGB, NULL, (GpBitmap **) &image);
	GdipGetImageGraphicsContext (image, &graphics);
...
TEST(Region, isVisibleRegionPointI)
{
	STARTUP
	GdipCreateBitmapFromScan0 (10, 10, 0, PixelFormat32bppRGB, NULL, (GpBitmap **) &image);
	GdipGetImageGraphicsContext (image, &graphics);
...
TEST(Region, isVisibleRegionRect)
{
	STARTUP
	GdipCreateBitmapFromScan0 (10, 10, 0, PixelFormat32bppRGB, NULL, (GpBitmap **) &image);
	GdipGetImageGraphicsContext (image, &graphics);
...
TEST(Region, isVisibleRegionRectI)
{
	STARTUP
	GdipCreateBitmapFromScan0 (10, 10, 0, PixelFormat32bppRGB, NULL, (GpBitmap **) &image);
	GdipGetImageGraphicsContext (image, &graphics);
...
TEST(Region, getRegionScansCount)
{
	STARTUP
	GdipCreateBitmapFromScan0 (10, 10, 0, PixelFormat32bppRGB, NULL, (GpBitmap **) &image);
	GdipGetImageGraphicsContext (image, &graphics);
...
TEST(Region, getRegionScans)
{
	...
	status = GdipGetRegionScans (region, scans, &count, matrix);
	ASSERT_EQ (Ok, status);
	ASSERT_FLOAT_EQ_NAN (11, scans[0].X);
	ASSERT_FLOAT_EQ_NAN (21, scans[0].Y);
	ASSERT_FLOAT_EQ_NAN (30, scans[0].Width);
	ASSERT_FLOAT_EQ_NAN (40, scans[0].Height);
	ASSERT_EQ (1, count);
	GdipDeleteRegion (region);
	...
	ASSERT_FLOAT_EQ_NAN (11, scans[0].X);
	ASSERT_FLOAT_EQ_NAN (21, scans[0].Y);
	ASSERT_FLOAT_EQ_NAN (31, scans[0].Width);
	ASSERT_FLOAT_EQ_NAN (41, scans[0].Height);
	ASSERT_EQ (1, count);
	GdipDeleteRegion (region);
	...
	status = GdipGetRegionScans (region, scans, &count, matrix);
	ASSERT_EQ (Ok, status);
	ASSERT_FLOAT_EQ_NAN (10, scans[0].X);
	ASSERT_FLOAT_EQ_NAN (20, scans[0].Y);
	ASSERT_FLOAT_EQ_NAN (30, scans[0].Width);
	ASSERT_FLOAT_EQ_NAN (40, scans[0].Height);
	ASSERT_EQ (1, count);
	...
	ASSERT_FLOAT_EQ_NAN (20, scans[0].Y);
	ASSERT_FLOAT_EQ_NAN (30, scans[0].Width);
	ASSERT_FLOAT_EQ_NAN (1, scans[0].Height);
	ASSERT_FLOAT_EQ_NAN (10, scans[1].X);
	ASSERT_FLOAT_EQ_NAN (21, scans[1].Y);
	ASSERT_FLOAT_EQ_NAN (31, scans[1].Width);
	ASSERT_FLOAT_EQ_NAN (39, scans[1].Height);
	ASSERT_EQ (2, count);
#endif
...
#else
	ASSERT_FLOAT_EQ_NAN (30, scans[0].Width);
	ASSERT_FLOAT_EQ_NAN (39, scans[0].Height);
#endif
	ASSERT_EQ (1, count);
	...
	status = GdipGetRegionScans (region, scans, &count, matrix);
	ASSERT_EQ (Ok, status);
	ASSERT_FLOAT_EQ_NAN (-4194304, scans[0].X);
	ASSERT_FLOAT_EQ_NAN (-4194304, scans[0].Y);
	ASSERT_FLOAT_EQ_NAN (8388608, scans[0].Width);
	ASSERT_FLOAT_EQ_NAN (8388608, scans[0].Height);
	ASSERT_EQ (1, count);
...
TEST(Region, getRegionScansI)
{
	...
	ASSERT_EQ (Ok, status);
	ASSERT_EQ (10, scans[0].X);
	ASSERT_EQ (20, scans[0].Y);
	ASSERT_EQ (30, scans[0].Width);
	ASSERT_EQ (40, scans[0].Height);
	ASSERT_EQ (1, count);
	...
	status = GdipGetRegionScansI (region, scans, &count, matrix);
	ASSERT_EQ (Ok, status);
	ASSERT_EQ (11, scans[0].X);
	ASSERT_EQ (21, scans[0].Y);
	ASSERT_EQ (30, scans[0].Width);
	ASSERT_EQ (40, scans[0].Height);
	ASSERT_EQ (1, count);
	GdipDeleteRegion (region);
	...
	ASSERT_EQ (11, scans[0].X);
	ASSERT_EQ (21, scans[0].Y);
	ASSERT_EQ (31, scans[0].Width);
	ASSERT_EQ (41, scans[0].Height);
	ASSERT_EQ (1, count);
	GdipDeleteRegion (region);
	...
	status = GdipGetRegionScansI (region, scans, &count, matrix);
	ASSERT_EQ (Ok, status);
	ASSERT_EQ (-4194304, scans[0].X);
	ASSERT_EQ (-4194304, scans[0].Y);
	ASSERT_EQ (8388608, scans[0].Width);
	ASSERT_EQ (8388608, scans[0].Height);
	ASSERT_EQ (1, count);
