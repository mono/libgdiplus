...
#else
ATTRIBUTE_USED static WCHAR *
wcharFromChar (const char *c)
{
...
ATTRIBUTE_USED static char *
charFromWchar (const wchar_t *wc)
{
...
printFailure (const char *file, const char *function, int line)
{
	fprintf (stderr, "Assertion failure: file %s in %s, line %d\n", file, function, line);
}

ATTRIBUTE_USED static void
assertEqualIntImpl (INT actual, INT expected, const char *message, const char *file, const char *function, int line)
{
	if (actual != expected) {
		if (message)
			fprintf (stderr, "%s\n", message);
...
ATTRIBUTE_USED static void
assertEqualFloatImpl (REAL actual, REAL expected, const char *message, const char *file, const char *function, int line)
{
...
ATTRIBUTE_USED static void
assertSimilarFloatImpl (REAL actual, REAL expected, REAL tolerance, const char *message, const char *file, const char *function, int line)
{
...
ATTRIBUTE_USED static BOOL
stringsEqual (const WCHAR *actual, const char *expected)
{
	int i = 0;
	while (TRUE) {
		if (expected[i] == '\0') {
...
ATTRIBUTE_USED static void
assertEqualStringImpl (const WCHAR *actual, const char *expected, const char *message, const char *file, const char *function, int line)
{
...
ATTRIBUTE_USED static void
assertEqualRectImpl (GpRectF actual, GpRectF expected, const char *message, const char *file, const char *function, int line)
{
...
ATTRIBUTE_USED static void
assertEqualPointImpl (Point actual, Point expected, const char *message, const char *file, const char *function, int line)
{
...
ATTRIBUTE_USED static void
assertEqualPointsImpl (const Point *actual, const Point *expected, INT count, const char *file, const char *function, int line)
{
...
ATTRIBUTE_USED static void
assertEqualPointFImpl (PointF actual, PointF expected, const char *message, const char *file, const char *function, int line)
{
...
ATTRIBUTE_USED static void
assertEqualPointsFImpl (const PointF *actual, const PointF *expected, INT count, const char *file, const char *function, int line)
{
	for (int i = 0; i < count; i++) {
		char iChar = i + '0';
...
ATTRIBUTE_USED static void
dumpBytes (const BYTE *bytes, int length)
{
	printf ("%u\n", length);
...
ATTRIBUTE_USED static void
assertEqualBytesImpl (const BYTE *actual, const BYTE *expected, int length, const char *message, const char *file, const char *function, int line)
{
	for (int i = 0; i < length; i++) {
...
ATTRIBUTE_USED static void
assertEqualGuidImpl (GUID actual, GUID expected, const char *message, const char *file, const char *function, int line)
{
...
ATTRIBUTE_USED static void
verifyMatrixImpl (GpMatrix *matrix, REAL e1, REAL e2, REAL e3, REAL e4, REAL e5, REAL e6, const char *file, const char *function, int line)
{
	GpStatus status;
	REAL elements[6];
...
ATTRIBUTE_USED static void
verifyRegionImpl (GpRegion *region, float expectedX, float expectedY, float expectedWidth, float expectedHeight, BOOL expectedIsEmpty, BOOL expectedIsInfinite, const char *file, const char *function, int line)
{
	GpImage *image;
	GpGraphics *graphics;
	GpStatus status;
...
ATTRIBUTE_USED static void
verifyRegionScansImpl (GpRegion *region, RectF *expectedScans, INT expectedCount, const char *file, const char *function, int line)
{
	GpStatus status;
	GpMatrix *matrix;
	INT count;
...
ATTRIBUTE_USED static void
verifyRegionDataImpl (GpRegion *region, BYTE *expected, INT expectedCount, const char *file, const char *function, int line)
{
	BYTE buffer[1024];
...
ATTRIBUTE_USED static void
verifyEmptyRegionImpl (GpRegion *region, const char *file, const char *function, int line)
{
...
ATTRIBUTE_USED static void
verifyInfiniteRegionImpl (GpRegion *region, const char *file, const char *function, int line)
{
...
ATTRIBUTE_USED static void
assertEqualARGBImpl (ARGB actual, ARGB expected, const char *message, const char *file, const char *function, int line)
{
	if (actual != expected) {
		if (message)
			fprintf (stderr, "%s\n", message);
...
ATTRIBUTE_USED static void
dumpPalette (ColorPalette *palette)
{
	for (UINT i = 0; i < palette->Count; i++) {
